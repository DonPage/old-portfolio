angular.module("donSite", ["ngRoute", "ngSanitize", 'angulartics', 'angulartics.google.analytics'])
    ...
    .controller("homeController", ['$scope', 'siteService', function ($scope, siteService) {
        siteService.closePage();
    }])

    .controller("workController", ['$scope', 'siteService', '$routeParams', function ($scope, siteService, $routeParams) {
...
//                }});
    ...
    .controller("egoController", ['$scope', 'siteService', function ($scope, siteService) {
        siteService.openPage();
    ...
    .controller("blogController", ['$scope', 'siteService', '$routeParams', function ($scope, siteService, $routeParams) {
        siteService.openPage();
    ...
    .controller("articleController", ['$scope', 'siteService', '$routeParams', function ($scope, siteService, $routeParams) {
